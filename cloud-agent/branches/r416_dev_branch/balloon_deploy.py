...
sh_command( "cd %s && sudo ./setup.py sdist" % an_engine_dir )
...
ssh.command( a_ssh_client, 'sudo apt-get install -y python-dev' )
ssh.command( a_ssh_client, 'sudo apt-get install -y python-setuptools' )
