...
<%!
	...
	*********************************************************************************/
	public HashMap CallShortcutExpressCheckout( HttpSession session,
												String paymentAmount, String currencyCodeType, String paymentType, 
	...
	/*********************************************************************************
	  ...
	  * Output: Returns a HashMap object containing the response from the server.
	*********************************************************************************/
	public HashMap CallMarkExpressCheckout( HttpSession session, 
								String paymentAmount, String currencyCodeType, String paymentType, String returnURL, 
	...
	*********************************************************************************/
	public HashMap ConfirmPayment(  HttpSession session,
			HttpServletRequest request, String finalPaymentAmount)
	{
...
<%
	...
	'------------------------------------
	*/
	gv_APIUserName	= "alexan_1276361000_biz_api1.gmail.com";
	gv_APIPassword	= "1276361006";
	gv_APISignature = "An5ns1Kso7MWUdW4ErQKJJJ4qi4-As0LKkRiI.deA1b.2evww5yY-hJj";
